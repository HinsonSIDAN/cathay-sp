---
title: Airlines
description: Per-airline earning tables — fare classes, Asia Miles rates and Status Points tiers for CX, all 14 oneworld partners, and every other Cathay airline partner.
tags: [index, airline, earning]
sensitivity: public
last_reviewed: '2026-07-14'
---

One entry per airline: which booking classes earn what when credited to Cathay. The
shared partner mechanics (zones, SP matrix) live in [[earning/partner-model]].

## Cathay Group

- [Cathay Pacific (CX)](cathay-pacific.md) — own earning table: SP by zone × cabin ×
  fare type; Asia Miles = SP × 100
- [HK Express (UO)](hk-express.md) — earns nothing; redemption partner only
...
- [Lufthansa (LH)](lufthansa.md) — limited German routes + HKG
- [SWISS (LX)](swiss.md) — limited Zurich routes + HKG
- [Shenzhen Airlines (ZH)](shenzhen-airlines.md) — mainland China domestic + HK/MO/TW

## Ended / suspended

- [Gulf Air (GF)](gulf-air.md) — partnership ended
- [S7 Airlines (S7)](s7-airlines.md) — oneworld membership suspended since 2022
